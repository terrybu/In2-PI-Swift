...
class AboutPIViewController: ParentViewController, UIScrollViewDelegate{
    ...
    private func setUpCanvasesInsideScrollView(viewWidth: CGFloat) {
        ...
        let viewCanvas3 = setUpCanvas3(viewWidth * 2, headerTitle: "목사님 인사말", bodyText: "크고 화려할 수록 아픈 사람이 많은 곳? 병원 그리고 교회입니다. 뉴욕이 크고 화려해서 아픈 사람이 많기에 Win2가 존재합니다. \n\n뉴욕을 지배하는 영은 허영입니다. 아는 척, 있는 척, 강한 척, 바쁜 척 살지만 실은 늘 두려움과 공허함과 목마름이 있습니다. 예수님께서 연약한 내 모습 그대로 사랑하시기에 Win2가 존재합니다. \n\n다들 잘 살기위해 아둥바둥 남을 먼저 짖밟고 죽여야 하는 곳, 하지만 정작 내가 목숨 걸 일은 찾지 못하기에 무언가에든 취해야 하는 곳. 그래서 깨어 기도하는 PI가 존재합니다. \n\n가족이 있지만 멀리 있고 보호자가 있지만 나를 보호하지 않았기에 가족과 사랑을 찾아 방황합니다. 그 어느 곳에도 예수님 같은 분이 없기에 Win2가 존재합니다. \n\n환자가 군사가 되는 곳, 내가 정직해 질 수 있는 곳, 뉴욕이 홈타운이 되는 이유, 내가 살 자리가 아니라 죽을 자리를 찾는 이들을 위한 청년공동체. 바로 Win2 입니다.")
